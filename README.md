...
|---|---|---|
| **[v1.0.2](https://github.com/skyphusion-labs/vivijure-local-16gb/releases/tag/v1.0.2)** | **Current stable** | `ghcr.io/skyphusion-labs/vivijure-local-16gb:1.0.2` |
...
The tracked `docker-compose.yml` pins **`1.0.2`** (see the `x-door-image` anchor at the top of that
...
```sh
docker compose pull   # fetches ghcr.io/skyphusion-labs/vivijure-local-16gb:1.0.2 (pinned in compose)
docker compose up
```

`docker compose` pulls the **v1.0.2** image named in `docker-compose.yml` (see
