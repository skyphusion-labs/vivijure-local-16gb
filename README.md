...
|---|---|---|
| **[v1.0.4](https://github.com/skyphusion-labs/vivijure-local-16gb/releases/tag/v1.0.4)** | **Current stable** | `ghcr.io/skyphusion-labs/vivijure-local-16gb:1.0.4` |
...
The tracked `docker-compose.yml` pins **`1.0.4`** (see the `x-door-image` anchor at the top of that
...
```sh
docker compose pull   # fetches ghcr.io/skyphusion-labs/vivijure-local-16gb:1.0.4 (pinned in compose)
docker compose up
```

`docker compose` pulls the **v1.0.4** image named in `docker-compose.yml` (see
