...
MINOR. SDXL cast train_lora on the local door (own silicon).
...
- Studio route (vivijure-core 1.9.0+): prefer LOCAL_BACKEND_URL for SDXL cast train; no RunPod required.
- **__version__ -> 1.1.0**; compose pin :1.1.0.
